...
schedule.every().friday.at("15:30").do(run_weekly_smc_scan)

if __name__ == "__main__":
    print("📡 SMC Scanner with Breaker + Inducement is running...")
    while True:
